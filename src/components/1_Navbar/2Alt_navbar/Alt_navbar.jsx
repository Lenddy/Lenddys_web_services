...
function Alt_navbar() {
	...
	return (
		<div className="alt-navBar">
			<div id="circularMenu" className={`circular-menu ${active_right ? "active" : ""}`}>
				<a className="floating-btn" onClick={() => setActive_right(!active_right)}>
			...
			{active_left ? (
				<div id="circularMenu1" className={`circular-menu circular-menu-left ${active_left ? "active" : ""}`}>
					<a className="floating-btn" onClick={() => setActive_left(!active_left)}>
				...
				<div id="circularMenu1" className={`circular-menu circular-menu-left ${active_left ? "active" : ""}`}>
					...
					<menu className="items-wrapper">
						<a href="#" className="menu-item " onClick={() => setActive_goTO(!active_goTO)}>
							seconde
						</a>
						<a href="#" className="menu-item ">
							seconde
