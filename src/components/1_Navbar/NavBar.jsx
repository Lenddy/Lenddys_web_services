...
const NavBar = ({ changeMode, setChangeMode, AnimationsRepetitionMode, setAnimationsRepetitionMode }) => {
	const welcomeRef = useRef(null);
	const what_I_DoRef = useRef(null);
	const toolsRef = useRef(null);
	const projectsRef = useRef(null);
	const profileRef = useRef(null);
	const allRefs = [welcomeRef, what_I_DoRef, toolsRef, projectsRef, profileRef];
	...
	function DropDown() {
			...
			return (
				<>
					<div
						...
						onClick={() => {
							props.goToMenu && setActiveMenu(props.goToMenu), props.section ? scrollToSection(props.section) : null;
						}}>
		...
		return (
			<div className="side-bar-dropDown" style={{ height: menuHeight }}>
				<CSSTransition in={activeMenu === "main"} unmountOnExit timeout={500} classNames="menu-primary" onEnter={calcHeight} onExit={calcHeight}>
					<div className="menu">
						<DropDownItem
							// leftIcon={"👋🏼"}
							// rightIcon={"👌"}
						...
						<a href="https://docs.google.com/document/d/1AD5kxapdVdUpXd1gBoQJV1Z41OVWd-XVgXe4O4iTDc0/edit?usp=sharing" target="_blank" rel="noreferrer" className="drop_down_a">
							<DropDownItem
							// leftIcon={"👋🏼"}
							// rightIcon={"👌"}
							// goToMenu="settings"
				...
				<CSSTransition in={activeMenu === "go_to_dropdown"} unmountOnExit timeout={500} classNames="menu-secondary" onEnter={calcHeight} onExit={calcHeight}>
					<div className="menu">
						<DropDownItem
							// leftIcon={"👍"}
							// rightIcon={"😂"}
				...
				<CSSTransition in={activeMenu === "Language_dropdown"} unmountOnExit timeout={500} classNames="menu-secondary" onEnter={calcHeight} onExit={calcHeight}>
					<div className="menu">
						<DropDownItem
							// leftIcon={"👍"}
							// rightIcon={"😂"}
						...
						<div onClick={() => i18next.changeLanguage("es")} className={i18next.language === "es" ? "disabled" : ""}>
							<DropDownItem
								// leftIcon={"👍"}
								// rightIcon={"😂"}
								goToMenu="main"
						...
						<div onClick={() => i18next.changeLanguage("en")} className={i18next.language === "en" ? "disabled" : ""}>
							<DropDownItem
								// leftIcon={"👍"}
								// rightIcon={"😂"}
								goToMenu="main">
				...
				<CSSTransition in={activeMenu === "socials_dropdown"} unmountOnExit timeout={500} classNames="menu-secondary" onEnter={calcHeight} onExit={calcHeight}>
					<div className="menu">
						<DropDownItem
							// leftIcon={"👍"}
							// rightIcon={"😂"}
						...
						<a href="https://github.com/Lenddy" target="_blank" rel="noreferrer" className="side_bar_a">
							<DropDownItem
								// leftIcon={"👍"}
								// rightIcon={"😂"}
								goToMenu="main"
						...
						<a href="https://www.linkedin.com/in/lenddy/" target="_blank" rel="noreferrer" className="side_bar_a">
							<DropDownItem
								// leftIcon={"👍"}
								// rightIcon={"😂"}
								goToMenu="main">
						...
						<a href="https://www.instagram.com/lenddys_web_services/" target="_blank" rel="noreferrer" className="side_bar_a">
							<DropDownItem
								// leftIcon={"👍"}
								// rightIcon={"😂"}
								goToMenu="main">
	...
	return (
		<>
			{windowWidth >= 1504 ? (
				<div className={`navbar ${hideNavBar}`} onMouseOver={() => onHover()} onMouseLeave={() => onMouseLeave()}>
					<ul className="">
						<li onClick={() => setOpenGoTo((prev) => !prev)}>
							...
							{openGoto && (
								<div className=" dropDownGoTo ">
									<ul className={`goTo_ul ${openGoto ? "Go_to_animation" : ""}`}>
										<li onClick={() => scrollToSection(welcomeRef)}>
											<p>
												{t("navBar_welcome")}
												{/* {cookieValue === "es"
													? "Bienvenida"
										...
										<li onClick={() => scrollToSection(what_I_DoRef)}>
											<p>
												{t("navBar_My_Experience")}
												{/* {cookieValue === "es"
													? "Lo Que Hago"
										...
										<li onClick={() => scrollToSection(toolsRef)}>
											<p>
												{t("navBar_Tools")}{" "}
												{/* {cookieValue === "es"
													? "Herramientas"
						...
						<li>
							<a href="https://docs.google.com/document/d/1AD5kxapdVdUpXd1gBoQJV1Z41OVWd-XVgXe4O4iTDc0/edit?usp=sharing" target="_blank" rel="noreferrer" className="resume_a">
								{t("navBar_resume")}
								{/* {cookieValue === "es" ? "Resumen" : "Resume"} */}
							</a>
						</li>
						...
						<li onClick={() => setOpenLanguage((prev) => !prev)}>
							...
							{openLanguage && (
								<div className="dropDownLanguage">
									<ul className={`goTo_ul ${openLanguage ? "Go_to_animation" : ""}`}>
										<li onClick={() => i18next.changeLanguage("es")} className={i18next.language === "es" ? "disabled" : ""}>
											<p>Español</p>
										</li>
										<li onClick={() => i18next.changeLanguage("en")} className={i18next.language === "en" ? "disabled" : ""}>
											<p>English</p>
										</li>
									</ul>
								</div>
						...
						<li onClick={() => setSocials((prev) => !prev)}>
							...
							{socials && (
								<div className="dropDownSocials">
									<ul className={`goTo_ul ${socials ? "Go_to_animation" : ""}`}>
										<li>
											<a href="https://github.com/Lenddy" target="_blank" rel="noreferrer">
												<Github />
											</a>
										</li>
										<li>
											<a href="https://www.linkedin.com/in/lenddy/" target="_blank" rel="noreferrer">
												<LinkedIn />
											</a>
										</li>
										<li>
											<a href="https://www.instagram.com/lenddys_web_services/" target="_blank" rel="noreferrer">
												<Instagram />
											</a>
										</li>
									</ul>
			...
			<div className="components_container ">
				<div ref={welcomeRef} className={` all_component `} id="welcome">
					<Welcome ref={allRefs} />
				</div>

				<div ref={what_I_DoRef} className={` all_component `} id="What_I_Do">
					<What_I_Do />
				</div>
				...
				<div ref={profileRef} className={` all_component `} id="Profile">
					<Profile />
				</div>
			</div>
		</>
