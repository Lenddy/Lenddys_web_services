...
const Tools = () => {
	...
	return (
		<div className="tool_container" ref={titleRef}>
			<GsapMagnetic>
				<div>
					<h1 className={`title ${isTitleVisible ? "title_animation" : ""}`}>
						{t("tools")}
						{/* {cookieValue === "es"
			...
			<div className="tools" ref={contentRef}>
				...
				<div className="languages">
					<GsapMagnetic>
						<a href="https://www.w3schools.com/html/html_intro.asp" target="_blank" rel="noreferrer">
							<div className={`tech_logos ${isContentVisible ? "logo_animation_1" : ""}`}>
								<img src={html} alt="" />
								<p>HTML</p>
							</div>
						</a>
					...
					<GsapMagnetic>
						<a href="https://www.w3schools.com/css/css_intro.asp" target="_blank" rel="noreferrer">
							<div className={`tech_logos ${isContentVisible ? "logo_animation_2" : ""}`}>
								<img src={css} alt="" />
								<p>CSS</p>
							</div>
						</a>
					...
					<GsapMagnetic>
						<a href="https://www.w3schools.com/js/js_intro.asp" target="_blank" rel="noreferrer">
							<div className={`tech_logos ${isContentVisible ? "logo_animation_3" : ""}`}>
								<img src={js} alt="" />
								<p>JAVASCRIPT</p>
							</div>
						</a>
					...
					<GsapMagnetic>
						<a href="https://www.w3schools.com/cs/cs_intro.php" target="_blank" rel="noreferrer">
							<div className={`tech_logos ${isContentVisible ? "logo_animation_1" : ""}`}>
								<img src={csharp} alt="" />
								<p>C SHARP</p>
							</div>
				...
				<div className="frameworks_libraries">
					<GsapMagnetic>
						<a href="https://www.w3schools.com/react/react_intro.asp" target="_blank" rel="noreferrer">
							<div className={`tech_logos ${isContentVisible ? "logo_animation_1" : ""}`}>
								<img src={react} alt="" />
								<p>REACT</p>
							</div>
					...
					<GsapMagnetic>
						<a href="https://pythonbasics.org/what-is-flask-python/" target="_blank" rel="noreferrer">
							<div className={`tech_logos ${isContentVisible ? "logo_animation_2" : ""}`}>
								<img src={flask} alt="" />
								<p>FLASK</p>
							</div>
				...
				<div className="databases">
					<GsapMagnetic>
						<a href="https://www.w3schools.com/mysql/mysql_intro.asp" target="_blank" rel="noreferrer">
							<div className={`tech_logos ${isContentVisible ? "logo_animation_1" : ""}`}>
								<img src={mysql} alt="" />
								<p>MySQL</p>
							</div>
					...
					<GsapMagnetic>
						<a href="https://www.w3schools.com/mongodb/mongodb_get_started.php" target="_blank" rel="noreferrer">
							<div className={`tech_logos ${isContentVisible ? "logo_animation_1" : ""}`}>
								<img src={mongodb} alt="" />
								<p>MONGODB</p>
							</div>
