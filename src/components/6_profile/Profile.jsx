...
import Lenddy from "../../assets/Lenddy2copy.jpg";
// import Lenddy from "../../assets/Lenddy3.jpg";
...
const Profile = () => {
	...
	return (
		<div
			...
			className={`profile `}>
			<div className={`profile_top flip_position ${isTitleVisible ? "turn_title" : ""}`} ref={titleRef}>
				<h1>
					{t("profile_title")}
			...
			<div className={`profileContainer `}>
				<div className={`profile_content_container ${isContentVisible ? "turn_content" : ""}`}>
					<div className="profile_left">
						...
						>
							<div className="card">
								<div className={`card__content ${isFlipped ? "flip_card" : ""}`}>
									<div className="card__front">
										<img className="profile_pic" src={Lenddy} alt=" profile picture" />
										{/* <p className="card__subtitle">
											Time for some fun
										</p> */}
										<h2 className={`card__title1 ${isFlipped ? "change_opacity" : ""}`}>
											{t("profile_hello")}
											{/* {cookieValue === "es" ? "HOLA" : "Hello"} */}
											{/* Hello */}
										</h2>
										<h4 className="card__title2">
											{t("profile_there")}
											{/* {cookieValue === "es" ? "QUE HAY" : "There"} */}
											{/* There */}
										</h4>
										<h4 className={`card__title3 ${isFlipped ? "change_opacity" : ""}`}>👋🏼</h4>
										<h4 className="card__title4">
											{t("profile_click")}
											{/* {cookieValue === "es" ? "HAS ME CLICK" : "Click Me"} */}
											{/* click me */}
										</h4>
									</div>
									...
									<div className="card__back">
										...
										<p className="card__body_part3">
											...
											{t("card__body_part3")}
											{/* {cookieValue === "es" ? "Me enseñó habilidades invaluables, incluido prosperar en situaciones de alto estrés, tanto individualmente como parte de un grupo. Aprendí la importancia de buscar ayuda cuando la necesito y ofrecer asistencia a los demás. Me inculcó el hábito de aprender de mis errores y ampliar continuamente mis conocimientos." : "taught me invaluable skills, including thriving in high-pressure situations, both individually and as part of a cohort. I learned the importance of seeking help when needed and offering assistance to others. It ingrained in me the habit of learning from my mistakes and continually expanding my knowledge."} */}
										</p>
										<p className="card__body_part4">
											{t("card__body_part4")}
											{/* {cookieValue === "es" ? "Mi objetivo final es regresar a la universidad algún día y reanudar mis estudios de ingeniería informática, con un posible enfoque en convertirme también en desarrollador de juegos o incluso explorar la carpintería." : "My ultimate goal is to return to college one day and resume my computer engineering studies, with a possible focus on also becoming a game developer or even exploring carpentry."} */}
										</p>
										<p className="card__body_part5">
											{t("card__body_part5")}
											{/* {cookieValue === "es" ? " En mi tiempo libre, me entrego a mi pasión por los videojuegos, el baloncesto, el béisbol, el anime, el manga escuchando Rock, Pop y Salsa. Si algo de esto le resuena o despierta su interés, no dude en enviarme un mensaje." : "In my free time, I indulge in my passion for video Games, Basketball, Baseball, Anime, Manga listening to Rock ,Pop and Salsa . If any of this resonates with you or piques your interest, feel free to send me a message. Don't hesitate"} */}
										</p>
									</div>
								</div>
							</div>
